...
DATABASES = {
    'default': {
        ...
        'HOST': 'awsproject-rds.c5aoaae8cyvz.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsprojectmerveblog' # please enter your s3 bucket name
